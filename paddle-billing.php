    ...
    public function init(): void
    {
        $this->getDi()->productTable->customFields()->add(
            new Am_CustomFieldSelect(
                ...
                'Optional. Category <a href="https://vendors.paddle.com/taxable-categories">MUST be approved</a> in your Paddle account (Default: standard). <a href="https://www.paddle.com/help/start/intro-to-paddle/why-do-i-need-to-select-\'taxable-categories\'-for-my-products" target="_blank">Learn more</a>',
                null,
